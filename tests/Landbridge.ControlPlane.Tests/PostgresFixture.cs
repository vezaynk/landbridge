...
public sealed class PostgresFixture : IAsyncLifetime
{
    ...
    public async Task ResetAsync()
    {
        ...
        await db.Database.ExecuteSqlRawAsync(
            "TRUNCATE sessions, worker_instances, registered_services, session_events, credentials, machines, lead_events, lead_teams, lead_machine_bindings, preview_mappings, relay_grants, team_forward_usage, session_usage, friction_reports, hub_queue RESTART IDENTITY CASCADE");
