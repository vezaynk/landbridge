...
| `landbridge-hub` | Wake SSE (`hub_queue` tail) plus JSON twins of domain rows. Same Postgres, own process. Unauthenticated until a client consumes it ([`hub-and-write-queue.md`](hub-and-write-queue.md)). |
